...
function test_grid_setup(N3)
    ...
    ABL.Grid.wavenumbers(gd, 1) == [0:31;]
    ABL.Grid.wavenumbers(gd, 2) == [0:31; -31:-1]
end
...
@timeit "Grid" @testset "Distributed Grid" begin
    test_grid_setup(16)
