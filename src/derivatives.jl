...
using ..Helpers
using ..Grids: NodeSet, nodes, wavenumbers, fdsize, vrange
using ..Domains: AbstractDomain as Domain, dx1factors, dx2factors
...
init_term(::Val{:strain12}) = (dependencies = (:vel1_2, :vel2_1),)
